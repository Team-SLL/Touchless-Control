 ...
 *
 * 얼굴 위치, 윤곽, 랜드마크 등을 그려서 출력
 * FaceDetectorProcessor protected void onSuccess() 에서 사용중
 */
public class FaceGraphic extends Graphic {
  private static final float FACE_POSITION_RADIUS = 1.0f;
  private static final float ID_TEXT_SIZE = 2.0f;
  private static final float ID_Y_OFFSET = 2.0f;
